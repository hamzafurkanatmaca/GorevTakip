...
namespace deneme.Mobile {
    ...
    public partial class denemeMobileApplication : MobileApplication {
        ...
        private deneme.Module.Mobile.denemeMobileModule module4;
        ...
        static denemeMobileApplication() {
        ...
        #endregion
        public denemeMobileApplication() {
        ...
        private void denemeMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new deneme.Module.Mobile.denemeMobileModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.denemeMobileApplication_DatabaseVersionMismatch);
