...
namespace deneme.Web {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class denemeAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private deneme.Module.denemeModule module3;
        private deneme.Module.Web.denemeAspNetModule module4;
        ...
        static denemeAspNetApplication() {
        ...
        #endregion
        public denemeAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void denemeAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new deneme.Module.denemeModule();
            this.module4 = new deneme.Module.Web.denemeAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.denemeAspNetApplication_DatabaseVersionMismatch);
